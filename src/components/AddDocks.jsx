...
export default function AddDocks({ open, close, setDockData }) {
    ...
    return (
        <>
            ...
            <div className={`fixed z-[12] w-[30rem] transition-all duration-200 ease-in-out rounded-2xl bg-[#72727258] text-white overflow-hidden ${open ? "h-72 py-4 px-5 opacity-[1px]" : "h-0 opacity-0"}`}>
