...
export const SettingsModal = ({ open, close }) => {
    ...
    const colors = [
      ...
      '#06b6d4', '#3b82f6', '#6366f1', '#ec4899', '#ef4444'
    ];
    ...
    return (
      <>
        ...
        <div className="fixed z-[21] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] bg-white rounded-2xl overflow-hidden">
          
          {/* Sidebar */}
          <div className="flex">
            <div className="w-1/3 bg-gray-50 p-6 border-r">
              <div className="space-y-4">
                <button className="w-full text-left px-4 py-3 bg-blue-500 text-white rounded-xl font-medium">
                  ⚙️ General
                </button>
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-gray-800">Open Website</span>
                  </div>
                  <select
                    value={openWebsite}
                    onChange={(e) => setOpenWebsite(e.target.value)}
                    className="px-4 py-2 border border-gray-300 rounded-lg bg-white"
                  >
                ...
                {/* Sign In */}
                <div className="pt-4">
                  <button className="w-full px-4 py-3 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors font-medium">
                    🔄 Sign In / Sync
                  </button>
                </div>
